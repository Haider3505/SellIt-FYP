          ...
          <div class="row" id="detail-21">
            <div class="col-md-5 single-top-left">
              <div class="flexslider">
                <ul class="slides">
                  <li :data-thumb="'http://localhost:3000/' + product.photo">
            ...
            <div class="col-md-6 single-top-right">
              ...
              <div class="single-rating">
                <ul v-if="averageRating">
                  <li v-for="_ in reviews" :key="_._id">
                    <i class="fa fa-star" aria-hidden="true"></i>
                  </li>
                  <li class="rating">{{ product.reviews.length }} reviews</li>
                </ul>
                <ul v-else>
                  <li>
                    <i class="far fa-star empty-star" aria-hidden="true"></i>
                  </li>
                  <li>
                    <i class="far fa-star empty-star" aria-hidden="true"></i>
                  </li>
              ...
              <div class="single-price">
                <ul>
                  ...
                  <li>
                    <del
                      >Pkr:{{
                        product.price + (product.price / 100) * 10.0
                      }}</del
                    >
                  </li>
...
export default {
  ...
  async asyncData({ $axios, params }) {
    try {
      ...
      const reviews = $axios.$get(`api/reviews/${params.id}`)
      ...
      let averageRating = 0
      const areviews = reviewsResponse.reviews
      if (areviews.length > 0) {
        let sum = 0
        for (let i = 0; i < areviews.length; i++) {
          sum += areviews[i].rating
        }
        averageRating = Math.ceil(sum / areviews.length)
      }
  ...
  methods: {
    ...
    addtoCart(product) {
      ...
      this.$toast
        .success(product.title + ' has been added to cart')
        .goAway(4000)
    },
  },
}
