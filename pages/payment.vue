          ...
          <div class="col-sm-6">
            ...
            <div class="a-section">
              ...
              <div class="a-section a-spacing-none a-spacing-top-small">
                <b>The total price is Pkr:{{ getCartTotalWithShipping }}</b>
              </div>
...
export default {
  ...
  mounted() {
    this.stripe = window.Stripe(
      'pk_test_51Jw2kIIyH6Np7BR6WXFvO2hUwcBm8DwEkgVGvXIPpb4zz8eNAdOSMgtRwBfxU9sGLduhevGXUASIOTHCvE5lQlOG00PxT41zfz'
    )
  ...
  methods: {
    async onPurchase() {
      try {
        const token = this.stripe.createToken(this.card)
        const response = await this.$axios.$post('/api/payment', {
          token,
          totalPrice: this.getCartTotalWithShipping,
          cart: this.getCart,
