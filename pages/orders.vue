                ...
                <div class="row">
                  <div class="col-xl-2 col-lg-2 col-2">
                    ...
                    <a href="#">
                      <img
                        :src="
                          'http://localhost:3000/' + product.productID.photo
                        "
                        class="img-fluid"
                        style="width: 100px"
                      />
                  ...
                  <div class="col-xl-10 col-lg-10 col-10">
                    ...
                    <div class="a-row">
                      ...
                      >
                      <!-- here product.quantity - product.productID.quantity -->
                    </div>
                    <div class="a-row">
                      <!-- Product price -->
                    ...
                    <div class="a-row">
                      <span
                        ...
                        @click="addtoCart(product.productID._id)"
                        >Buy it again</span
                      >
                      <nuxt-link
  ...
  methods: {
    calculateTotal(orders) {
      ...
      for (let i = 0; i < orders.length; i++) {
        for (let j = 0; j < orders[j].products.length; j++) {
          total += Number(
    ...
    async addtoCart(productId) {
      try {
        ...
        this.$toast
          .success(response.product.title + ' has been added to cart')
          .goAway(4000)
      } catch (error) {
        console.log(error)
      }
